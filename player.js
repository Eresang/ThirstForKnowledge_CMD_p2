...
function initPlayer() {
    ...
    kc_spacekey = game.input.keyboard.addKey(Phaser.Keyboard.C);
...
function playerDeath() {
    ...
    sc_text = game.add.text(0, 0, 'You have been defeated\nYour grade: ' + getScore(false) + '\n\nPress c to continue...', sc_textstyle);
